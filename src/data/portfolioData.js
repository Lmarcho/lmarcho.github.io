export const portfolioData = {
  ...
  skills: [
    { name: "Magento 2", category: "eCommerce" },
    { name: "PHP 8.x", category: "Backend" },
    { name: "MySQL", category: "Database" },
    { name: "React JS", category: "Frontend" },
    { name: "JavaScript", category: "Frontend" },
    { name: "GraphQL", category: "API" },
    { name: "PWA Studio", category: "eCommerce" },
    { name: "AWS", category: "Cloud" },
    { name: "AWS Autoscaling", category: "Cloud" },
    { name: "AWS Load Balancing", category: "Cloud" },
    { name: "Redis", category: "Cache" },
    { name: "Elasticsearch", category: "Search" },
    { name: "Knockout JS", category: "Frontend" },
    { name: "LESS/CSS", category: "Frontend" },
